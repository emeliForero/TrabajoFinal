...
class Ventana():
    ...
    def titulo(self, titleText):
        self.title = Label(text=titleText, font=("Cambria", 13), bg="#DB82F3", fg="black", width="450", height="2")
        self.title.pack()
    ...
    def botones(self, textName, positionX, positionY):
        self.buttonLoad = Button(self.mainWindow, text=textName, command=self.getUsers,font=("Cambria", 11), width="20", height="2", bg="#DB82F3")
